<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT id FROM reginfo WHERE email = '$myusername' and password = '$mypassword'";
...
<nav class="navbar navbar-expand-lg navbar-dark orange darken-1 sticky-top" style="font-family:'Source Code Pro', monospace;">
  ...
  <div class="collapse navbar-collapse" id="basicExampleNav">
	...
	<div class="d-flex justify-content-center" style="padding-top:5%;">
      ...
      <h1 class="white-text text-center" style="font-family:egypt_font;font-size:300%;color:#FFC312!important">Faculty Login</h1>
			...
			<div class="card-body">
				<form action="" method="POST">
					<div class="input-group form-group">
						...
						<input onclick="changeImageRev('user.gif')" type="text" name="email" class="form-control" placeholder="email" required>
					...
					<div class="form-group text-center">
						<input name="submit" type="submit" value="Login" class="btn login_btn">
					</div>
				</form>
			</div>
